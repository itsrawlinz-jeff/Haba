...
<center>
    ...
    <h2> <b>GOLD MEMBERSHIP PLAN</b> </h2>
...
<body style="background-color:  #ffff99 ;color:black">
    ...
    <div class="container">
        <form name="match" class="" action="goldaction.php" method="post">
...
?>
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <select class="custom-select" name="plan" inputGroupSelect01" readonly>
                        ...
                        <option name=" plan" value=" Haba Gold" readonly>Haba Gold $75</option>
            ...
            <p>
                <input type="submit" name="save" id="Submit"
                    onclick="window.location.href = 'http://localhost/LOGIN/loginsystem/MPESA/index.php';" type="submit"
