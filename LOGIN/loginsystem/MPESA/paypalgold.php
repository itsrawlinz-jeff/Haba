      ...
      <div style="text-align: center;">
        <div style="margin-bottom: 1.25rem;">
          ...
          <select id="item-options">
            <option value="GOLD PACKAGE" price="75" readonly>GOLD PACKAGE - 75 USD</option>
          <!-- <option value="PLATINUM PACKAGE" price="150" readonly>PLATINUM PACKAGE - 150 USD</option> -->
