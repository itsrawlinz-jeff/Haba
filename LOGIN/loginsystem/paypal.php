...
<div id="smart-button-container">
      <div style="text-align: center;">
        <div style="margin-bottom: 1.25rem;">
          ...
          <select id="item-options"><option value="GOLD PACKAGE" price="75">GOLD PACKAGE - 75 USD</option><option value="PLATINUM PACKAGE" price="150">PLATINUM PACKAGE - 150 USD</option><option value="DIAMOND PACKAGE" price="200">DIAMOND PACKAGE - 200 USD</option></select>
