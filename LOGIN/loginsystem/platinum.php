...
<center>
    <h1> <b>FILL FORM TO REQUEST MATCH</b> </h1>
        <h2> <b>(PLATINUM MEMBERSHIP PLAN)</b> </h2>
...
<body style="background-color:  #ffff99 ;color:black">
    ...
    <div class="container">
        <form name="match" class="" action="plataction.php" method="post">
...
?>
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <select class="custom-select" name="plan" inputGroupSelect01" readonly>
                        ...
                        <option name=" plan" value=" Haba Silver" readonly>Haba Platinum $150</option>
                        <!-- <option name="plan" value=" Haba Bronze">Haba Bronze $200</option> -->
            ...
            <p>
                <input type="submit" name="save" id="Submit"
                    onclick="window.location.href = 'http://localhost/LOGIN/loginsystem/MPESA/platinumpay.php'" type="submit"
